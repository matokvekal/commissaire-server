...
1.parent_register
urpose: Registers a parent's device with the system. The parent must enter their mobile phone number. They are allowed up to 3 attempts; upon exceeding this limit, they must wait 20 minutes before trying again.
Method: POST
Payload:
...
Error (exceeding attempts): {"status": "error", "message": "Exceeded attempts, please wait 20 minutes."}
